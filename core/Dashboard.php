 ...
 * Provides methods to fetch dashboard highlights and statistics
 * Uses ORM for database interactions
 */
class Dashboard
{
   /**
    * Get dashboard highlights including total members, monthly revenue,
    * average midweek attendance, and average Sunday attendance.
    * @return array
    */
